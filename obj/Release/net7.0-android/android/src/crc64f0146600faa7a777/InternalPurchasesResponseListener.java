...
public class InternalPurchasesResponseListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Android.BillingClient.Api.InternalPurchasesResponseListener, Xamarin.Android.Google.BillingClient", InternalPurchasesResponseListener.class, __md_methods);
	}


	public InternalPurchasesResponseListener ()
	{
		super ();
		if (getClass () == InternalPurchasesResponseListener.class) {
			mono.android.TypeManager.Activate ("Android.BillingClient.Api.InternalPurchasesResponseListener, Xamarin.Android.Google.BillingClient", "", this, new java.lang.Object[] {  });
		}
	}
